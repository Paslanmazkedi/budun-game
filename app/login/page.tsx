...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full text-stone-100 flex flex-col overflow-hidden animate-page-enter">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-start pt-28 sm:justify-center sm:pt-0 p-6 safe-bottom">
        <div className="w-full max-w-sm space-y-6">
          <div className="flex flex-col items-center text-stone-200">
            <img
              src={LOGIN_LOGO}
              alt="Budun Online"
              className="w-36 h-36 sm:w-48 sm:h-48 mb-3 sm:mb-2 object-contain drop-shadow-[0_12px_32px_rgba(6,182,212,0.25)]"
            />
          ...
          <div className="bg-stone-950/75 backdrop-blur-xl border border-stone-800/80 rounded-2xl p-6 shadow-[0_24px_48px_rgba(0,0,0,0.5)] space-y-5">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-stone-50 text-stone-700 font-medium text-sm py-3 rounded-lg border border-stone-300/80 transition active:scale-[0.98] shadow-sm flex items-center justify-center gap-3"
            >
