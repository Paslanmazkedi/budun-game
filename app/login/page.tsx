    ...
    <div className="relative min-h-screen w-full text-stone-100 flex flex-col overflow-hidden animate-page-enter">
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{ opacity: cfg.overlayOpacity / 100 }}
        />
      </div>

      <div
        className={`relative z-10 flex-1 flex flex-col items-center p-6 safe-bottom ${
          cfg.showLogoOnMobile
            ? `justify-start ${cfg.mobileTopPadding} sm:justify-center sm:pt-0`
            : 'justify-end pb-14 sm:justify-center sm:pb-0 sm:pt-0'
        }`}
      >
        <div className="w-full max-w-sm space-y-5">
          <div
            className={`flex flex-col items-center text-center ${cfg.showLogoOnMobile ? '' : 'hidden sm:flex'}`}
          >
            <div className="login-logo-wrap" style={loginLogoCssVars(cfg.logo)}>
              <img src={LOGIN_LOGO} alt={cfg.logoAlt} className="login-logo-img" />
            </div>
          </div>
